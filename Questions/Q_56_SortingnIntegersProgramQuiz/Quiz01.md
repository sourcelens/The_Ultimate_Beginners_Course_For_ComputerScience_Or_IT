...
<img src="Images/Q_56_39_2.jpg" width="400"/>
...
<img src="Images/Q_56_40_1.jpg" width="400"/>  
...
<img src="Images/Q_56_43_1.jpg" width="400"/>  
<img src="Images/Q_56_43_2.jpg" width="400"/>
...
After the instruction jl SwapValues, it will jump to SwapValues. As seen from the register values shown, the value of EBX is 0x1 and EDX is 3, cmp ebx, dword ptr[esp + edx * 4] will boil down to cmp 4, dword ptr[esp + 3 * 4] which is cmp 1, dword ptr[esp + 0Ch] (0Ch is hex value of 12). Now the value inside the memory location [esp + 0Ch] is 0x4 and 0x1 is less than 0x4. So it will jump to SwapValues, whose EIP is 00BB1442 which it is evident from the disassembly shown.  

---
---


44 : We have the below program,  
...
<img src="Images/Q_56_44_1.jpg" width="400"/>  
<img src="Images/Q_56_44_2.jpg" width="400"/>
...
Inc edx will increment the value of EDX register by 1. Here the value of EDX is 3 as seen from the register values shown, so it will become 00000004.  

---
---


45 : We have the below program,  
...
EAX = 00000000 EBX = 00000001 ECX = 00000000 EDX = 00000004 ESI = 00000004 EDI = 00000000 EIP = 00BB142B ESP = 012FF76C EBP = 012FF84C EFL = 00000295
